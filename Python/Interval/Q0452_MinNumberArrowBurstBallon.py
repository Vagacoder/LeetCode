#
# * 452. Minumum Number of Arrows to Burst Balloons
# * Medium
...
# * -axis. A balloon with xstart and xend bursts by an arrow shot at x if xstart
...
sol = Solution()
a1 = [[10,16],[2,8],[1,6],[7,12]]
r1 = sol.findMinArrowShots(a1)
print(r1)
